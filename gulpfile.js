...
var sources = {
    ...
    extras: ['.bowerrc','config.js','url.js','util.js','package.json','bower.json','README.md']
};
...
gulp.task('develop', ['build'], function() {
    nodemon({ script: 'url.js', ext: 'js css ms', ignore: ['dist/*','public/library/*','node_modules/*'], nodeArgs: ['--debug']  })
        .on('start', function() {
